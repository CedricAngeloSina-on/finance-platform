...
import { DataTableViewOptions } from "~/features/accounts/components/data-table-view-options";
...
export function DataTableToolbar<TData>({
  ...
  const [confirm, ConfirmationDialog] = useConfirm(
    ...
    table.getFilteredSelectedRowModel().rows.length > 1
      ? "Do you really want to delete these accounts? This process cannot be undone."
